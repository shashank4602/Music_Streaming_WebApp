...
//         if (isPaused) {
//             playSound("https://res.cloudinary.com/djnajyew1/video/upload/v1712576991/hafswkujaag1cky44d2v.mp3");
//             setIsPaused(false);
//         }
//         else {
//             pauseSound();
...
//                     </div>
//                     <div className="px-5">
//                         <div className="border border-gray-100 text-white w-2/5 flex px-2 py-1 rounded-full items-center justify-center">
//                             <Icon icon="carbon:earth-europe-africa" />
//                             <div className="ml-2 text-sm font-semibold">English</div>
//                         </div>
//                     </div>
//                 </div>
//                 {/*This 2nd div will be the ri8 panel*/}
...
//                     <img
//                         src="https://images.unsplash.com/photo-1712562007990-e7673d34ca42?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxlZGl0b3JpYWwtZmVlZHwyfHx8ZW58MHx8fHx8"
...
//                     <div className="flex w-1/3 justify-between items-center">{/*Controls for playing song here*/}
//                         <Icon icon="ph:shuffle-fill" fontSize={30}
//                             className="cursor-pointer text-gray-500 hover:text-white"
//                         />
//                         <Icon icon="mdi:skip-previous-outline" fontSize={30}
//                             className="cursor-pointer text-gray-500 hover:text-white"
//                         />
//                         <Icon
//                             icon={isPaused ? "ic:baseline-play-circle" : "ic:baseline-pause-circle"} fontSize={50}
//                             className="cursor-pointer text-gray-500 hover:text-white"
//                             onClick={togglePlayPause}
//                         />
//                         <Icon icon="mdi:skip-next-outline" fontSize={30}
//                             className="cursor-pointer text-gray-500 hover:text-white"
//                         />
